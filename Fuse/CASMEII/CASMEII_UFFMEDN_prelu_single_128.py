...
def evaluate(segment_train_images, segment_validation_images, segment_train_labels, segment_validation_labels,test_index,segment_train_images_cat ,segment_validation_images_cat):
    ...
    # ract_1 = PReLU()(conv1)
    conv1 = Convolution2D(96, (9, 9), strides=(3, 3), padding='same')(ract_2114)
    ract_211 = PReLU()(conv1)
    # 3x3 conv
    conv3 = Convolution2D(256, (9, 9), strides=(3, 3), padding='same')(ract_2114)
    ...
    pool = Convolution2D(32, (9, 9), strides=(3, 3), padding='same')(pool)
    ract_213 = PReLU()(pool)
    ...
    conv15 = Convolution2D(256, (5, 5), strides=1, padding='same')(layer_out)
