...
def evaluate(segment_train_images, segment_validation_images, segment_train_labels, segment_validation_labels,test_index,segment_train_images_cat ,segment_validation_images_cat):
    ...
    # ract_1 = PReLU()(conv1)
    conv1 = Convolution2D(96, (8, 8), strides=(2, 2), padding='same')(ract_2114)
    ract_211 = PReLU()(conv1)
    # 3x3 conv
    conv3 = Convolution2D(256, (8, 8), strides=(2, 2), padding='same')(ract_2114)
    ...
    pool = Convolution2D(32,  (8, 8), strides=(2, 2), padding='same')(pool)
    ract_213 = PReLU()(pool)
...
testtype = "loocv"
###################################
notes="no input both  (8, 8), strides=(2, 2)dropout .5"
####################################
