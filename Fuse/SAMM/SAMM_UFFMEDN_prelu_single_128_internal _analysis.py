...
def evaluate(segment_train_images, segment_validation_images, segment_train_labels, segment_validation_labels,test_index,segment_train_images_cat ,segment_validation_images_cat):
    ...
    # ract_1 = PReLU()(conv1)
    conv1 = Convolution2D(64, 1, strides=1, padding='same')(ract_2114)
    ract_211 = PReLU()(conv1)
    # 3x3 conv
    conv3 = Convolution2D(256, 1, strides=1, padding='same')(ract_2114)
    conv3 = Convolution2D(512, (3, 3), padding='same')(conv3)
    ract_212 = PReLU()(conv3)
    # 5x5 conv
    conv5 = Convolution2D(96, 1, strides=1, padding='same', activation=PReLU())(ract_2114)
    ...
    pool = Convolution2D(32, 1, strides=1, padding='same')(pool)
    ract_213 = PReLU()(pool)
